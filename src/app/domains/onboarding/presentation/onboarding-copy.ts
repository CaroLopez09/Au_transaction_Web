...
import { OnboardingStage } from '../domain/onboarding-status';
 ...
 */
export function stageCopy(stage: OnboardingStage, companyName: string, canManage: boolean): StageCopy {
  ...
  switch (stage) {
    ...
    case 'product-pending':
      return {
        ...
        explanation: 'Faltan requisitos específicos del producto de cuentas en EE. UU.' + whoActs,
        awaitsOrganization: true,
      };
    case 'ready':
      return {
    ...
    case 'rejected':
      return {
        ...
        explanation:
          'El proveedor no comparte el motivo en esta consulta. Contacta a soporte de AU para conocer la ruta de corrección.',
        awaitsOrganization: true,
      };
    case 'unknown':
      return {
